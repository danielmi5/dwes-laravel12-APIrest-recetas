 ...
 *
 * Controlador API para registro, login y gestión de sesión.
 *
...
class AuthController extends Controller
{
    ...
    {
        // Logout de usuario, para ello se elimina el token actual
    ...
    {
        // Se devuelven los datos del usuario autenticado
